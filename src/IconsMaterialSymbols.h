...
#define FONT_ICON_FILE_NAME_MSO "Assets/Fonts/MaterialSymbolsOutlined[FILL,GRAD,opsz,wght].ttf"
#define FONT_ICON_FILE_NAME_MSR "Assets/Fonts/MaterialSymbolsRounded[FILL,GRAD,opsz,wght].ttf"
